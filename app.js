                                    ...
                                    <td style="padding: 10px; border: 1px solid var(--line);">
                                        <div class="app-rate-card">                                           
                                            <div class="stacked-tiers-list" style="display:flex; flex-direction:column; gap:2px;">
                                                ${tiers.map((t, idx) => `
                                                    <div class="tier-entry" style="position:relative; padding: 4px; border-radius: 4px; margin-bottom: 4px; background: rgba(255,255,255,0.02);">
                                                        <button class="card-delete-btn" onclick="OL.removeAppTier('${analysisId}', '${appObj.appId}', ${idx})" 
                                                                style="position:absolute; top:-2px; right:-8px; background:none; border:none; color:var(--danger); cursor:pointer; font-size:14px; padding:0; z-index: 10;">×</button>
                                                        
                                                        <div style="display:flex; align-items: center; gap:6px; width: 100%;">
                                                            <input type="text" class="price-input-tiny" 
                                                                style="flex: 1; min-width: 0; color: var(--text-main); background:transparent; border: 1px solid var(--panel-border); font-size: 10px; padding: 2px 4px;" 
                                                                placeholder="Tier Name" value="${esc(t.name)}" 
                                                                onblur="OL.updateAppTier('${analysisId}', '${appObj.appId}', ${idx}, 'name', this.value)">
                                                            
                                                            <div style="display:flex; align-items:center; gap:2px; width: 55px; flex-shrink: 0;">
                                                                <span class="tiny muted" style="font-size: 9px;">$</span>
                                                                <input type="number" class="price-input-tiny" 
                                                                    style="width:100%; color: var(--text-main); background:transparent; border: 1px solid var(--panel-border); text-align: right; font-size: 10px; padding: 2px;" 
                    ...
                    <td style="padding: 6px; border: 1px solid var(--line); vertical-align: top; min-width: 140px; background: rgba(255,255,255,0.01);">
                        <div style="display: flex; flex-direction: column; gap: 4px;">
                            <div style="display: flex; justify-content: space-between; align-items: center; gap: 4px;">
                                ...
                                <div style="display: ${isNotIncluded ? 'none' : 'flex'}; align-items: center; gap: 8px; background: rgba(0,0,0,0.2); border-radius: 4px; padding: 2px 5px; flex: 1;">
                                ...
                                ${isNotIncluded ? '<div style="flex: 1;"></div>' : ''}

                                <select class="tiny-select" 
                                    style="width: ${isNotIncluded ? '100%' : 'auto'}; flex-shrink: 0;"
                            ...
                            <div id="addon-price-${appObj.appId}-${feat.id}" 
                                ...
                                <span class="tiny muted">Add-on Price: $</span>
                                <input type="number" class="price-input-tiny" style="max-width:50px; color: var(--accent); background:transparent; border: 1px solid var(--panel-border); font-size: 10px;"
                                    value="${currentAddonPrice}" 
                                    onblur="OL.updateAppFeatAddonPrice('${analysisId}', '${appObj.appId}', '${feat.id}', this.value)">
                            </div>

                            <textarea ... >${esc(currentNote)}</textarea>
                        </div>
                    </td>
                `;
            }).join('');
    ...
    return `
        <div class="round-section" style="margin-bottom: 25px; border: 1px solid var(--panel-border); border-radius: 8px; overflow: hidden;">
            <div class="grid-row round-header-row" style="background: rgba(56, 189, 248, 0.1); border-bottom: 1px solid var(--accent);">
                ...
                <div class="col-numeric bold" style="