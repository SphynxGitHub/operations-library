                                                ...
                                                ${tiers.map((t, idx) => `
                                                    <div class="tier-entry" style="position:relative; padding: 6px; border-radius: 4px;">
                                                        ...
                                                        <div style="display:flex; justify-content: space-between; gap:4px;">
                                                            <input type="text" class="price-input-tiny" style="width:100%; color: var(--main-text); background:transparent;  border: 1px solid var(--panel-border);" 
                                                            ...
                                                            <div style="display:flex; align-items:center; gap:4px;">
                                                                <span class="tiny muted">$</span>
                                                                <input type="number" class="price-input-tiny" style="width:100%; color: var(--main-text); background:transparent;  border: 1px solid var(--panel-border);" 
