    ...
    main.innerHTML = `
        ...
        <div class="card" style="padding: 14px 16px; margin-bottom: 20px; background: rgba(var(--accent-rgb), 0.04); border: 1px solid var(--accent);">
            <form onsubmit="event.preventDefault(); OL.createClientQuickTask('${client.id}');" class="quick-task-form">
                ...
                <input type="date" id="client-quick-task-duedate" class="modal-input tiny qtf-field" style="flex:1 1 150px; min-width:150px;" title="Due Date">
                ...
                <button type="submit" class="btn tiny primary qtf-field" style="flex:0 0 110px; min-width:100px; height:36px; font-weight: bold; display:flex; align-items:center; justify-content:center; gap:4px;">
