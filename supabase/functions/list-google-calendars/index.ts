// ================================================================================================
// FUNCTION: list-google-calendars
//
// WHAT IT DOES:   Lists every calendar on the connected Google account, including
//                 hidden ones, so you can choose which to sync in Manage Calendars.
//
// CALLED BY:      The Manage Calendars window.
//
...
//
// READS/CHANGES:  Reads Google Calendar only. Changes nothing.
//
